...
<table border="0">
 <tr>
    <td>- [Syllabus](/files/pdf/teaching/PC-Syllabus.pdf)</td>
    <td>- [Materials](/pattern-classification.md)</td>
 </tr>
</table>
...
- Digital Image Processing (Spring 2017)
    - [Syllabus](/files/pdf/teaching/DIPSyllabus.pdf)
    - [Materials](/digital-image-processing.md)
